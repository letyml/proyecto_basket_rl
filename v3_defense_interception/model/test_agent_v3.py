...
from BasketballBoardVisual import BasketballBoardVisualV3
...
def play_episode(csv_path, episodio=0, fps=5, enable_countdown=False, visual=True):
    ...
    env = BasketballBoardVisualV3(render_mode="human")
...
if __name__ == "__main__":
    nombre_modelo = input("Nombre del modelo (ej. model_v3_YYYYMMDD_HHMMSS): ").strip()
