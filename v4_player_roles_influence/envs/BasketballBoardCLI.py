from BasketballBoardBaseEnv import BasketballBoardBaseEnvV4
import random

class BasketballBoardCLIV4(BasketballBoardBaseEnvV4):
    """
    Clase para la simulación CLI del entorno de baloncesto.
    Esta clase hereda de BasketballBoardBaseEnvV4 y proporciona una interfaz de línea de comandos
