...
class BasketballBoardVisualV4(BasketballBoardBaseEnvV4):
    """
    Clase para la simulación visual del entorno de baloncesto.
    Esta clase hereda de BasketballBoardBaseEnvV4 y proporciona una interfaz gráfica
